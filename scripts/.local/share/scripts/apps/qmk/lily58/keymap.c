...
/* KC_ALGR = Alt-gr  */
/* KC_NUBS = <  */
/* SC_LSPO = LEFT SHIFT WHEN HOLD, ( WHEN TAPPED */
/* SC_RSPC = right SHIFT WHEN HOLD, ) WHEN TAPPED */
/* KC_LEAD = leaderkey  */
/* create macro for \ */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // TG() toggles layer
    // KC_LEAD, for leader, enable it in rules.mk as well, also uncomment the
    // leader sectio

    [_COLEMAK] =
        LAYOUT(CAPS_EMU, WK1, WK2, WK3, WK4, WK5, WK6, WK7, WK8, WK9, WK0,
               LGUI(LCM_W), KC_TAB, LCM_Q, LCM_W, LCM_F, LCM_P, LCM_G, LCM_J,
               LCM_L, LCM_U, LCM_Y, LCM_NTIL, KC_LBRC, KC_ESC, LCM_A, LCM_R,
               LCM_S, LCM_T, LCM_D, LCM_H, LCM_N, LCM_E, LCM_I, LCM_O, LCM_QUOT,
               SC_LSPO, LCM_Z, LCM_X, LCM_C, LCM_V, LCM_B, LCM_BSLS, KC_AMPR,
               LCM_K, LCM_M, LCM_COMM, LCM_DOT, LCM_MINS, SC_RSPC,
               LGUI_T(KC_ENT), OSL(_RAISE), LALT_T(KC_ENT), CTL_T(KC_DEL),
               KC_BSPC, LT(_LOWER, KC_SPC), ROPT_T(KC_F5), LT(_ADJUST, KC_DEL)),
    ...
    /*  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,
       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \ */
    /*              MO(_LOWER),KC_LGUI, KC_LALT, LT(_LOWER,KC_SPC),
       LT(_RAISE,KC_ENT),  KC_BSPC, KC_RGUI, MO(_RAISE) \ */
    /* ), */
    /* LOWER
     * ,-----------------------------------------.
     * ,-----------------------------------------. |      |      |      |      |
    ...
    [_LOWER] =
        LAYOUT(_______, _______, _______, _______, _______, _______, _______,
               _______, _______, _______, _______, _______, _______, KC_EXLM,
               KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR,
               KC_LPRN, KC_RPRN, LCM_GRV, _______, KC_1, KC_2, KC_3, KC_4, KC_5,
               KC_6, KC_7, KC_8, KC_9, KC_0, LCM_IQUE, _______, LCM_LABK,
               LCM_AT, LCM_RABK, LCM_CIRC, LCM_TILD, _______, _______, LCM_BSLS,
               LCM_PIPE, COMM_SPC, LCM_DOT, LCM_PLUS, _______, _______, _______,
    ...
    [_RAISE] =
        LAYOUT(_______, _______, _______, _______, _______, _______, _______,
               _______, _______, _______, _______, _______, XXXXXXX, KC_F1,
               KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,
               XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_F11, KC_F12,
               LSFT(KC_PSCR), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, XXXXXXX,
               XXXXXXX, _______, XXXXXXX, KC_MEDIA_SELECT, KC_MEDIA_PLAY_PAUSE,
               LALT(KC_F4), _______, _______, _______, XXXXXXX, XXXXXXX,
               SCLN_END, COLN_END, _______, _______, _______, _______, _______,
               _______, _______, RCTL_T(KC_SPC), LT(_ADJUST, KC_SPC), _______),
    ...
    [_ADJUST] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_SYSTEM_POWER, KC_SYSTEM_SLEEP,
        XXXXXXX, KC_BRID, KC_BRIU, XXXXXXX, XXXXXXX, XXXXXXX, KC_INS, XXXXXXX,
        XXXXXXX, XXXXXXX, KC_CAPS, XXXXXXX, KC_MUTE, KC_VOLD, KC_VOLU, KC_CLEAR,
        KC_HOME, KC_PGDN, KC_PGUP, KC_END, XXXXXXX, KC_LSFT, _______, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
...
/* It's possible to start timers and read values for time-specific events.
 * Here's an example: */
...
/*         SEND_STRING("rfgxebma" SS_TAP(X_P) " iagam " SS_TAP(X_MINS) "vapuakg
 * cyifmae\n"); */
/**/
/*     } */
/*     SEQ_TWO_KEYS(SC_RSPC, LCM_C) { */
/*         //PERMANENT */
/*         // sudo localectl set-x11-keymap latam pc104 colemak && sudo
 * localectl set-keymap colemak */
/*         SEND_STRING("rlsy iycaifcgi rfg" SS_TAP(X_MINS) "x11" SS_TAP(X_MINS)
 * "efjma" SS_TAP(X_P) " iagam " SS_TAP(X_P) "c104 cyifmae " SS_LSFT("77") "
 * rlsy iycaifcgi rfg" SS_TAP(X_MINS) "efjma" SS_TAP(X_P) " cyifmae\n"); */
/*     } */
