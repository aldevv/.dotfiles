 ...
 */
 [_COLEMAK] = LAYOUT( \
  ...
  SC_LSPO,   LCM_Z,  LCM_X,   LCM_C,   LCM_V,    LCM_B, DF(_COLEMAK_EMU),  DF(_MAC),  LCM_K,    LCM_M,    LCM_COMM, LCM_DOT,  LCM_MINS,  SC_RSPC,\
           KC_F11, OSL(_RAISE), CTL_T(KC_BSPC), LALT_T(KC_DEL),   LGUI_T(KC_ENT), LT(_LOWER,KC_SPC), ROPT_T(KC_F5), LT(_ADJUST, KC_F12) \
),
 ...
 */
  ...
  SC_LSPO,   LCM_Z,  LCM_X,   LCM_C,   LCM_V,    LCM_B, DF(_COLEMAK_EMU),  DF(_COLEMAK),  LCM_K,    LCM_M,    LCM_COMM, LCM_DOT,  LCM_MINS,  SC_RSPC,\
          KC_F11, OSL(_RAISE), LGUI_T(KC_BSPC), LALT_T(KC_DEL),   LCTL_T(KC_ENT), LT(_LOWER,KC_SPC), ROPT_T(KC_F5), LT(_ADJUST, KC_F12) \
  )
};
