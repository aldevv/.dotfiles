...
awful.screen.connect_for_each_screen(function(s)
  ...
  local lowWhite = "#646464"
  local black = "#000000"

  -- beautiful.tasklist_shape_border_color = green
  ...
  beautiful.taglist_fg_volatile = green
  beautiful.taglist_disable_icon = true
  beautiful.taglist_squares_sel = "" -- removes the annoying little f***ing rectangles
...
--   autoclose               = false,
--   floating                = false,
--   geometry                = { x = 500, y = 400, height = 800, width = 1000 },
--   reapply                 = true,
...
-- awful.key({ modkey, }, "-", scratchpad.toggle_send, { description = "Send to scratch pad", group = "Scratchpad" })
