# Karpathy-extended rules

Source: https://github.com/forrestchang/andrej-karpathy-skills (community distillation, not Karpathy-authored). Rules below are verbatim from that repo.
