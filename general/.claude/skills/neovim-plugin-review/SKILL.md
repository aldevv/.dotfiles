...
If none of those exist, ask the user to confirm the path before fanning out — five agents on a non-plugin is wasted work. If the only thing the user actually wants reviewed is the README, hand off to `readme-md-improver` instead.
