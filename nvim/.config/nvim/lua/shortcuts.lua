...
vim.keymap.set("n","<localleader>tlH", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~>', cwd = '~', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tld.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/.dotfiles>', cwd = '~/.dotfiles', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tluu", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $REMOTES>', cwd = '$REMOTES', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlrr", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/repos>', cwd = '~/repos', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tln.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $NOTES>', cwd = '$NOTES', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlN.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $ATOMIC>', cwd = '$ATOMIC', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlwo", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $WORK>', cwd = '$WORK', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlbk", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $BOOKS>', cwd = '$BOOKS', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlbK", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $BOOKS/ln>', cwd = '$BOOKS/ln', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlba", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $BACKUPS>', cwd = '$BACKUPS', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlll", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $LEARN>', cwd = '$LEARN', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tll.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $LEARN>', cwd = '$LEARN', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlT.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $TRASH>', cwd = '$TRASH', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlTt", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $TRASH>', cwd = '$TRASH', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlTr", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $HOME/Downloads/torrents>', cwd = '$HOME/Downloads/torrents', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlsk", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $SUCKLESS>', cwd = '$SUCKLESS', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlf.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $XDG_CONFIG_HOME>', cwd = '$XDG_CONFIG_HOME', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlv.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $XDG_CONFIG_HOME/nvim>', cwd = '$XDG_CONFIG_HOME/nvim', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlvl", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $XDG_CONFIG_HOME/nvim/lua/lsp>', cwd = '$XDG_CONFIG_HOME/nvim/lua/lsp', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlva", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $XDG_CONFIG_HOME/nvim/lua/config/automation>', cwd = '$XDG_CONFIG_HOME/nvim/lua/config/automation', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlvt", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $XDG_CONFIG_HOME/nvim/lua/config/appearance/themes>', cwd = '$XDG_CONFIG_HOME/nvim/lua/config/appearance/themes', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlvc", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $XDG_CONFIG_HOME/nvim/lua/core>', cwd = '$XDG_CONFIG_HOME/nvim/lua/core', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlvC", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $XDG_CONFIG_HOME/nvim/lua/config>', cwd = '$XDG_CONFIG_HOME/nvim/lua/config', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlvu", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $XDG_CONFIG_HOME/nvim/lua/utils>', cwd = '$XDG_CONFIG_HOME/nvim/lua/utils', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlvk", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $XDG_CONFIG_HOME/nvim/lua/config/keybindings>', cwd = '$XDG_CONFIG_HOME/nvim/lua/config/keybindings', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlsn", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/.config/nvim/my_snippets/snipmate/>', cwd = '~/.config/nvim/my_snippets/snipmate/', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlsN", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/.config/nvim/my_snippets/luasnips>', cwd = '~/.config/nvim/my_snippets/luasnips', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlvL", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/.config/nvim/lua/lsp/snippets>', cwd = '~/.config/nvim/lua/lsp/snippets', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlm.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $SCRIPTS>', cwd = '$SCRIPTS', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlff", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $FILES>', cwd = '$FILES', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlu.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $UTILITIES>', cwd = '$UTILITIES', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tla.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $AUTOMATION>', cwd = '$AUTOMATION', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlA.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $APPS>', cwd = '$APPS', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlml.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $MLIBS>', cwd = '$MLIBS', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlO", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/Downloads>', cwd = '~/Downloads', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlo", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/Documents>', cwd = '~/Documents', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlvv", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/Videos>', cwd = '~/Videos', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlwa", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $WALL>', cwd = '$WALL', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlwi", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $WIKI>', cwd = '$WIKI', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlwp", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $WIKI/personal>', cwd = '$WIKI/personal', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlwS", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $WIKI/cheatsheets>', cwd = '$WIKI/cheatsheets', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlmm", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/Music>', cwd = '~/Music', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlca", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/.cache>', cwd = '~/.cache', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlloo", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/.local>', cwd = '~/.local', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tllos", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/.local/share>', cwd = '~/.local/share', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tllon", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/.local/share/nvim>', cwd = '~/.local/share/nvim', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tllol", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/.local/share/nvim/lazy>', cwd = '~/.local/share/nvim/lazy', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tllom", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/.local/share/nvim/mason>', cwd = '~/.local/share/nvim/mason', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tllob", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/.local/bin>', cwd = '~/.local/bin', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRe", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /etc>', cwd = '/etc', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRU", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /usr>', cwd = '/usr', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRus", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /usr/share>', cwd = '/usr/share', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRub", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /usr/bin>', cwd = '/usr/bin', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRui", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /usr/include>', cwd = '/usr/include', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRulo", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /usr/local>', cwd = '/usr/local', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRulob", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /usr/local/bin>', cwd = '/usr/local/bin', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRulos", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /usr/local/share>', cwd = '/usr/local/share', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRuloi", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /usr/local/include>', cwd = '/usr/local/include', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRuli", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /usr/lib>', cwd = '/usr/lib', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlex.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /opt/exploitdb/exploits>', cwd = '/opt/exploitdb/exploits', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRv", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /var>', cwd = '/var', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRb", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /bin>', cwd = '/bin', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRr", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /root>', cwd = '/root', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRo", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /opt>', cwd = '/opt', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlRmn", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP /mnt>', cwd = '/mnt', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlsc", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/Pictures/screenshots>', cwd = '~/Pictures/screenshots', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlvo", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $VOLUMES>', cwd = '$VOLUMES', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlan.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/.local/share/ansible>', cwd = '~/.local/share/ansible', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlP", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $PROGRAMS/>', cwd = '$PROGRAMS/', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlp", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $PROJECTS/>', cwd = '$PROJECTS/', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlc.", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $PLAYGROUND/code>', cwd = '$PLAYGROUND/code', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlpp", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP ~/Pictures>', cwd = '~/Pictures', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n","<localleader>tlpl", ":lua require('telescope.builtin').grep_string({prompt_title = '<LIVE GREP $PLAYGROUND>', cwd = '$PLAYGROUND', search ='', only_sort_text = true, shorten_path = true, word_match = '-w'})<cr>", { noremap = true, silent = true })
