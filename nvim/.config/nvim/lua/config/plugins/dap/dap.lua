...
-- save current keybinding, replace them and then restore them when event terminated
for _, server in ipairs(servers) do
	require("dap").listeners.after.event_initialized[server] = function()
		vim.keymap.set(
			{ "n" },
			"<leader>n",
	...
	require("dap").listeners.before.event_terminated[server] = function()
		vim.keymap.set("n", "<leader>n", ":lua require('neotest').run.run()<CR> ")
