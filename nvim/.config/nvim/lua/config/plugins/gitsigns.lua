...
vim.keymap.set({ "n", "v" }, "<leader>gss", "<cmd>Gitsigns stage_hunk<CR>")
vim.keymap.set("n", "<leader>gsu", "<cmd>Gitsigns undo_stage_hunk<CR>")
vim.keymap.set({ "n", v }, "<leader>gsrr", "<cmd>Gitsigns reset_hunk<CR>")
vim.keymap.set("n", "<leader>gsrb", "<cmd>Gitsigns reset_buffer<CR>")
vim.keymap.set("n", "<leader>gsrB", "<cmd>Gitsigns reset_buffer_index<CR>") -- this doesn't undo changes!!
vim.keymap.set("n", "<leader>gsp", "<cmd>Gitsigns preview_hunk<CR>")
vim.keymap.set("n", "<leader>gsi", function()
  require("gitsigns").preview_hunk_inline()
end)
vim.keymap.set("n", "<leader>gsb", '<cmd>lua require"gitsigns".blame_line{full=true}<CR>')
vim.keymap.set("n", "<leader>gsS", "<cmd>Gitsigns stage_buffer<CR>")
vim.keymap.set("n", "<leader>gsq", "<cmd>Gitsigns setqflist<CR>")
vim.keymap.set("n", "<leader>gsl", "<cmd>Gitsigns setloclist<CR>")
