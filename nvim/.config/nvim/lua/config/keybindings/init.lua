...
map("n", "<localleader>.vv", ":e " .. h .. "/init.lua<cr>", nor_s)
map("n", "<localleader>.vs", ":e " .. h .. "/lua/config/settings.lua<cr>", nor_s)
map("n", "<localleader>.vc", ":e " .. h .. "/lua/core/<cr>", nor_s)
map("n", "<localleader>.vC", ":e " .. h .. "/lua/config/<cr>", nor_s)
...
map("n", "<localleader>.vu", ":e " .. h .. "/lua/utils/lua/telescope.lua<cr>", nor_s)

-- moving to folder
map("n", "<localleader>v.", "<cmd>cd " .. h .. "<cr> | <cmd>e .<cr>", nor_s)
map("n", "<localleader>vv", "<cmd>cd " .. h .. "<cr> | <cmd>e .<cr>", nor_s)
map("n", "<localleader>vl", "<cmd>cd " .. h .. "/lua/lsp/<cr> | <cmd>e .<cr>", nor_s)
map("n", "<localleader>va", "<cmd>cd " .. h .. "/lua/config/automation/<cr> | <cmd>e .<cr>", nor_s)
map("n", "<localleader>vc", "<cmd>cd " .. h .. "/lua/core/<cr> | <cmd>e .<cr>", nor_s)
map("n", "<localleader>vC", "<cmd>cd " .. h .. "/lua/config/<cr> | <cmd>e .<cr>", nor_s)
map("n", "<localleader>vu", "<cmd>cd " .. h .. "/lua/utils/<cr> | <cmd>e .<cr>", nor_s)
map("n", "<localleader>vk", "<cmd>cd " .. h .. "/lua/config/keybindings/<cr> | <cmd>e .<cr>", nor_s)
map("n", "<localleader>ll", "<cmd>cd $LEARN<cr> | <cmd>e .<cr>", nor_s)
map("n", "<localleader>pl", "<cmd>cd $PLAYGROUND<cr> | <cmd>e .<cr>", nor_s)
map("n", "<localleader>ex.", "<cmd>cd /opt/exploitsdb/exploits<cr> | <cmd>e .<cr>", nor_s)
map("n", "<localleader>c.", "<cmd>cd $PLAYGROUND/code<cr> | <cmd>e .<cr>", nor_s)
map("n", "<localleader>n.", "<cmd>cd $NOTES<cr> | <cmd>e .<cr>", nor_s)
