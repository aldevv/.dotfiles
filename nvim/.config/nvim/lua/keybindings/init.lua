...
map("n", "Ect", ":lua require('utils.lua.copilot').toggle_copilot()<cr>", desc("Copilot Toggle "))

map("n", "Ecc", ":CopilotChat", desc("Copilot Chat"))
map("n", "Ecp", ":Copilot panel<cr>", desc("Copilot Panel [[ and ]] to jump solutions")) --use [[ and ]] to jump solutions
map("n", "Ecv", ":CopilotChatExplain", desc("Copilot Chat Explain"))
map("n", "Ecd", ":CopilotChatDocs", desc("Copilot Chat Docs"))
